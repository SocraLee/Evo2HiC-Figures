"""Supplementary Figure 20: Hi-C heatmaps over the 2-Mb regions where the
two SR methods most disagree, for two of the largest-Δ TAD-F1 species.

Visual evidence accompanying Supplementary Figure 19.
...
within ±3 bins (30 kb) — same tolerance as the F1 metric in Supp Fig 19.
...
- Boundary counts shown in Supp 19 / TSV are chromosome-wide totals, not
...
DISPLAY_SIGMA    = 1.0
BOUNDARY_ZONE    = 3            # match tolerance ±3 bins (30 kb), same as F1 in supp19
OUT_PDF = ensure_out_dir() / 'supplementary_20.pdf'
...
def matched_pred_boundaries(bounds_obs, bounds_pred, zone=BOUNDARY_ZONE):
    ...
    at most once).  Same matching rule as boundary_f1 in supp19."""
